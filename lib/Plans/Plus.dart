...
class PlusPlanScreen extends StatefulWidget {
  @override
  _PlusPlanScreenState createState() => _PlusPlanScreenState();
}

class _PlusPlanScreenState extends State<PlusPlanScreen> {
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: Color(0xFF275661), // Plus blue color
  ...
  Widget _buildMainTitle() {
    return Text(
      'Get unlimited likes and more features with Travel Plus™',
      style: TextStyle(
        color: Colors.white,
        fontSize: 28,
        fontWeight: FontWeight.bold,
  ...
  Widget _buildPlanCard(Map<String, dynamic> plan, int index) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isSelected
            ? Color(0xFF275661)
            : Colors.white.withOpacity(0.1), // Plus blue for selected
